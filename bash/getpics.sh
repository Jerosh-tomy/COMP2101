...
# download a tar file of pictures to our Pictures directory if it isn't already there - assumes you are online
...
# unpack the downloaded tar file to our Pictures directory and delete the local copy of tar file
